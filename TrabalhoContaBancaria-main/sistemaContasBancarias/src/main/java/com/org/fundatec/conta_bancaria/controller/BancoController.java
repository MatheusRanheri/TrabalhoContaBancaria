...
public class BancoController {
    ...
    public ResponseEntity<Banco> buscaPeloId(@PathVariable("id") Integer id)throws RegistroNaoEncontradoException {
    ...
    public ResponseEntity<List<Banco>> buscarPorNomeAprox(@PathVariable("nome") String nome) {
