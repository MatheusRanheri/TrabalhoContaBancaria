...
public class AgenciaController {
    ...
    public ResponseEntity<Agencia> buscarPorBanco(@PathVariable("codigo") Banco banco, @RequestParam("codigo") Integer codigo)throws RegistroNaoEncontradoException {
        Banco novoBanco = bancoService.cadastrarBanco(banco);
