...
public class ContaController {
    ...
    @GetMapping(value = { "consulta-numero/{numero}" }, consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = { "{conta}" }, consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Conta> editar(@PathVariable("conta") Integer id, @RequestBody Conta conta) {
