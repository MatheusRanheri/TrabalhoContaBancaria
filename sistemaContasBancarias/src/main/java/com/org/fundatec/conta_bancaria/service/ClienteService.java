...
public class ClienteService {
    ...
    public Cliente busca(Integer numId) throws RegistroNaoEncontradoException {
        Optional<Cliente> busca = clienteRepository.findClienteById(numId);
    ...
    public Cliente editar(Integer numId, Cliente cliente) throws RegistroNaoEncontradoException{
        Cliente clienteBusca = this.busca(numId);
