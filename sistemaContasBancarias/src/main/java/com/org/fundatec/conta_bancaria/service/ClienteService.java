...
public class ClienteService {
    ...
    public List<Cliente> buscarNomeAprox(String nome){
        List<Cliente> clientes = clienteRepository.findClienteByNomeContains(nome);

        if(clientes.isEmpty()){
            throw new RegistroNaoEncontradoException("Nenhum cliente encontrado com esse nome");
        }
