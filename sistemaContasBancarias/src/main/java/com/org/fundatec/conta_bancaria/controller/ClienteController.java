...
public class ClienteController {
    ...
    public ResponseEntity<Cliente> buscarPeloId(@PathVariable("id") Integer id)throws RegistroNaoEncontradoException {
    ...
    public ResponseEntity<List<Cliente>> buscarPorNomeAprox(@PathVariable("nome") String nome) {
